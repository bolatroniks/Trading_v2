...
modelname = 'Pure_LSTM_Less_Variables_Bit_Larger_Model'
...
for i in range (0):
    my_train.modelname = 'Pure_LSTM_Less_Variables_Bit_Larger_Model'
        ...
        try:
            ...
            if True:
                try:                
                    ...
                    my_train.loadDataSet(series_list=series_list,begin=k, end=k+15)
                    ...
                    f.write ('Loaded series:'+str(series_list[k])+', '+str(series_list[k+1])+', '+str(series_list[k+2])+', '+str(series_list[k+3])+', '+str(series_list[k+4])+', '+str(series_list[k+5])+', '+str(series_list[k+6])+', '+str(series_list[k+7])+', '+str(series_list[k+8])+', '+str(series_list[k+9])+', '+str(series_list[k+10])+
                            str(series_list[k+11])+', '+str(series_list[k+12])+', '+str(series_list[k+13])+', '+str(series_list[k+14])+', '+str(series_list[k+15])+'\n')
                except:
