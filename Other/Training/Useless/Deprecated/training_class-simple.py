...
#this one is more sophisticated than the very simple one
#it attempts to use a window of data without recurring to RNN
...
class My_Training ():
    ...
    def train (self, verbose=False):
        ...
        hist = self.model.fit(self.X[300:-np.mod(len(self.X)-300,batch_size),:], self.y[300:-np.mod(len(self.X)-300,batch_size)], batch_size=batch_size, nb_epoch=1)
