...
modelname = 'Pure_LSTM_3x1024_Layers_variable_length'
...
class PredictAheadModel (TradingModel):
    ...
    def buildModel (self):
        ...
        self.model.add(LSTM(1024, dropout_W=0.2, dropout_U=0.2, stateful=False, return_sequences=True))
        self.model.add(Dropout(0.2))
        
        self.model.add(LSTM(1024, dropout_W=0.2, dropout_U=0.2, stateful=False, return_sequences=False))
        self.model.add(Dropout(0.2))
...
for i in range (0):
    my_train.modelname = 'Pure_LSTM_3x1024_Layers_variable_length'
    f = open (logpath+my_train.modelname,'a')
