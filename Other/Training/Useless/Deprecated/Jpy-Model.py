...
class PredictAheadModel (TradingModel):
    ...
    def plotPredictionsByNo (self, series_no, data='cv'):
     ...
     def buildModel (self):
        ...
        #self.model.add(Dropout(0.2))
        #self.model.add(Dense(512))
        self.model.add(Dense(512, W_regularizer=l2(0.000001), activity_regularizer=activity_l2(0.000001)))
        ...
        self.model.add(Dense(1, W_regularizer=l2(0.000001)))
