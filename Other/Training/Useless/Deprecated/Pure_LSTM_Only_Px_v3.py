...
modelname = 'Pure_LSTM_Only_Px_No_Bias_v3'
...
class PredictAheadModel (TradingModel):
    ...
    def buildModel (self):
        ...
        self.model.add(Dense(1, b_regularizer=l2(10000), W_regularizer=l2(0.00001), bias=False))
...
my_train = PredictAheadModel (modelname=modelname,
                            ...
                            lookback_window=126, cv_set_size=750,
                            test_set_size=1750)
...
for i in range (0):
    my_train.modelname = 'Pure_LSTM_Only_Px_No_Bias_v3'
    f = open (logpath+my_train.modelname,'a')
