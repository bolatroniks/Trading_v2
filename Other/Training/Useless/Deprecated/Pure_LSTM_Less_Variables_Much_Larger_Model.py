...
modelname = 'Pure_LSTM_Less_Variables_Much_Larger_Model'
...
class PredictAheadModel (TradingModel):
    ...
    def buildModel (self):
        ...
        self.model.add(Dense(1, b_regularizer=l2(10000), W_regularizer=l2(0.00001)))
...
if False:
    ...
    try:
        my_train.loadModel ()
        w = my_train.model.layers[12].get_weights ()
        w[1][0] = 0
        my_train.model.layers[12].set_weights (w)
    except:
        pass
...
for i in range (0):
    my_train.modelname = 'Pure_LSTM_Less_Variables_Much_Larger_Model'
    f = open (logpath+my_train.modelname,'a')
