...
modelname = 'Pure_LSTM_Less_Variables_Larger_Model'
...
class PredictAheadModel (TradingModel):
    ...
    def buildModel (self):
        ...
        self.model.add(LSTM(1024, dropout_W=0.5, dropout_U=0.1, stateful=False, return_sequences=True, input_shape=(self.dataset.lookback_window, self.dataset.n_features)))
        self.model.add(Dropout(0.5))
        self.model.add(LSTM(512, dropout_W=0.1, dropout_U=0.1, stateful=False, return_sequences=True))
        self.model.add(Dropout(0.5))
        self.model.add(LSTM(256, dropout_W=0.1, dropout_U=0.1, stateful=False, return_sequences=True))
        self.model.add(Dropout(0.5))
        self.model.add(LSTM(256, dropout_W=0.1, dropout_U=0.1, stateful=False, return_sequences=False))
        self.model.add(Dropout(0.5))
...
for i in range (10000):
    my_train.modelname = 'Pure_LSTM_Less_Variables_Larger_Model'
    f = open (logpath+my_train.modelname,'a')
