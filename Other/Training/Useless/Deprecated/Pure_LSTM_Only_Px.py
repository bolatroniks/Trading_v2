...
modelname = 'Pure_LSTM_Only_Px_No_Bias'
...
class PredictAheadModel (TradingModel):
    ...
    def buildModel (self):
        ...
        self.model.add(LSTM(256, dropout_W=0.2, dropout_U=0.2, stateful=False, return_sequences=False))
        self.model.add(Dropout(0.2))
...
for i in range (0):
    my_train.modelname = 'Pure_LSTM_Only_Px_No_Bias'
    f = open (logpath+my_train.modelname,'a')
