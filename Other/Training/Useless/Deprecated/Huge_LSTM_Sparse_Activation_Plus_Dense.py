...
class PredictAheadModel (TradingModel):
    ...
    def buildModel (self):
        ...
        self.model.add(LSTM(4096, dropout_W=0.05, dropout_U=0.05, regularizers=activity_l1, 
                            stateful=False, return_sequences=False, input_shape=(self.dataset.lookback_window, self.dataset.n_features)))
